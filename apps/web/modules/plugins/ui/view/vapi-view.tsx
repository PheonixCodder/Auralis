...
const vapiFeatures: Feature[] = [
  {
    ...
    description: "Make and receive voice calls directly from your app.",
  },
  {
    icon: PhoneIcon,
    label: "Phone numbers",
  ...
  },
  {
    icon: WorkflowIcon,
    label: "Workflows",
    description: "Create custom automated voice workflows.",
  },
];
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent>
        ...
        <DialogDescription>
          Your API keys are safely encrypted and will only be used to connect
          your Vapi account to our plugin. We do not store your API keys in
          plaintext or use them for any other purpose.
        </DialogDescription>
        <Form {...form}>
          <form
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent>
        ...
        <DialogDescription>
          Are you sure you want to disconnect the Vapi plugin? This will remove
          all your Vapi settings and you will need to reconnect the plugin to
          use it again.
        </DialogDescription>
        <DialogFooter>
...
const VapiView = () => {
  ...
  const toggleConnection = () => {
    if (vapiPlugin) {
      setRemoveOpen(true);
      toast.error("Vapi plugin is already connected");
    } else {
      setConnectOpen(true);
    }
  };
