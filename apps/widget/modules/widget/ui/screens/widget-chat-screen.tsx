...
import { contactSessionIdAtomFamily, conversationIdAtom, orgIdAtom, screenAtom } from "@/modules/widget/atoms/widget-atoms"
...
export const WidgetChatScreen = () => {
    ...
    return (
        ...
        <WidgetHeader className="flex items-center justify-between">
            ...
            <Button variant={"transparent"} size={"icon"}><MenuIcon /></Button>
        </WidgetHeader>
        <AIConversation>
