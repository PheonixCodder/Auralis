...
import { contactSessionIdAtomFamily, errorMessageAtom, loadingMessageAtom, orgIdAtom, screenAtom } from '@/modules/widget/atoms/widget-atoms';
...
export const WidgetLoadingScreen = ( { organizationId }: { organizationId: string | null } ) => {
    ...
    }, [step, organizationId, setErrorMessage, setLoadingMessage, setOrgId, validateOrg, setScreen])
